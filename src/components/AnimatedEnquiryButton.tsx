...
interface AnimatedEnquiryButtonProps {
  children: React.ReactNode;
  variant?: 'primary' | 'secondary';
  className?: string;
}

const AnimatedEnquiryButton = ({ children, variant = 'primary', className = '' }: AnimatedEnquiryButtonProps) => {
...
export default AnimatedEnquiryButton; 